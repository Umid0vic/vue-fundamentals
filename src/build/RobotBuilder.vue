<template>
    ...
    <div class="middle-row">
      ...
      <div class="center part">
        <img v-bind:src="availableParts.torsos[selectedTorseIndex].src" title="left arm"/>
        <button v-on:click="selectPreviousTorse()" class="prev-selector">&#9668;</button>
        <button v-on:click="selectNextTorse()" class="next-selector">&#9658;</button>
      </div>
